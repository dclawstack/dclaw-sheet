...
import { Table2, Plus, Trash2, Database, Activity, LogOut, User as UserIcon, Home } from "lucide-react";
    ...
    <main className="min-h-screen bg-gray-50">
      <header className="bg-[#10B981] px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="text-white/80 hover:text-white" title="Home">
